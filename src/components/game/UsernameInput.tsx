...
const UsernameInput = ({ onSubmit, savedUsername }: UsernameInputProps) => {
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <motion.button
            ...
            className="w-full bg-primary text-primary-foreground px-8 py-4 rounded-2xl text-xl font-semibold shadow-lg hover:shadow-xl transition-shadow disabled:opacity-50 disabled:cursor-not-allowed"
